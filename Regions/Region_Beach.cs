    ...
    internal class Region_Beach
    {
        ...
        public static void AddRegion()
        {
            ...
            RegionManager.New("Beach", 2, true)
                ...
                .CreateEncounter("BirdOfTheSea")
                    #region
                    .AddDominantTribes(Tribe.Bird)
                    .CreateTurn()
                        .AddCardBlueprint("SkeletonParrot")
                        .AddCardBlueprint("Kingfisher")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 18, replacement: "SkeletonParrot")
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 13, replacement: "Kingfisher")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 13, replacement: "SkeletonParrot")
                        .AddCardBlueprint("SkeletonParrot")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 18, replacement: "SkeletonParrot")
                    ...
                    .CreateTurn()
                        ...
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 18, replacement: "Kingfisher")
                        .Build()
            #endregion
                    .Build()
                .CreateEncounter("TideOfFish")
                 #region
                    .AddDominantTribes(Tribe.Bird)
                    .AddRandomReplacementCards("re_Schoolling_Fish", "Shark", "Kingfisher")
                    .SetRedundantAbilities(Ability.Submerge)
                    .CreateTurn()
                        .AddCardBlueprint("re_Moon_Jellyfish")
                        .AddCardBlueprint("Kingfisher")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint("re_Moon_Jellyfish", difficultyReplace: true, difficultyReplaceReq: 18, replacement: "re_Costal_Salmon")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint("re_Moon_Jellyfish", difficultyReplace: true, difficultyReplaceReq: 13, replacement: "re_Schoolling_Fish")
                        .AddCardBlueprint("Kingfisher", difficultyReplace: true, difficultyReplaceReq: 19, replacement: "Shark")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 13, replacement: "re_Schoolling_Fish")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 15, replacement: "re_Costal_Salmon")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 17, replacement: "re_Schoolling_Fish")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 19, replacement: "Shark")
                        .Build()
            #endregion
                    .Build()
                .CreateEncounter("CrabsAndLobster")
                    #region
                    .AddDominantTribes(Tribe.Bird)
                    .AddRandomReplacementCards("re_Schoolling_Fish", "Shark", "Kingfisher", "re_Moon_Jellyfish")
                    .SetRedundantAbilities(Ability.Submerge)
                    .CreateTurn()
                        .AddCardBlueprint("re_Jonah_Crab")
                        .AddCardBlueprint("Kingfisher")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint("Kingfisher", difficultyReplace: true, difficultyReplaceReq: 13, replacement: "re_American_Lobster")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint("re_Jonah_Crab", difficultyReplace: true, difficultyReplaceReq: 18, replacement: "re_American_Lobster")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint("Kingfisher", difficultyReplace: true, difficultyReplaceReq: 20, replacement: "re_American_Lobster")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 13, replacement: "re_Jonah_Crab")
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 13, replacement: "re_Jonah_Crab")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint("re_Jonah_Crab", difficultyReplace: true, difficultyReplaceReq: 13, replacement: "re_American_Lobster")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint("Kingfisher", difficultyReplace: true, difficultyReplaceReq: 15, replacement: "re_Jonah_Crab")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 17, replacement: "re_American_Lobster")
                        .Build()
                    .CreateTurn()
                        .AddCardBlueprint(null, difficultyReplace: true, difficultyReplaceReq: 19, replacement: "re_Jonah_Crab")
                        .Build()
                     #endregion
                    .Build()
